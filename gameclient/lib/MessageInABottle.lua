...
require 'lib/GraphicsStateStack.lua'
...
Default values
--]]
MessageBottle.DEFAULT_SOUND = 'sound/blip.ogg'
MessageBottle.DEFAULT_VOLUME = 0.5
MessageBottle.DEFAULT_BUTTON = ' ' --Button to close/select
MessageBottle.DEFAULT_INDICATOR = love.graphics.newImage('img/input-indicator.png') --Image to 
